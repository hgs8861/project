...
\[ S = \int_{-1}^{1} (x^3-x^2-x+1) dx = 2 \int_{0}^{1} (-x^2+1) dx = 2 \left[ -\frac{1}{3}x^3 + x \right]_0^1 = \frac{4}{3} \]
...
\[ S = 2 \left\{ \int_0^1 (x^2+2) dx + \int_1^2 (-x^2+4) dx \right\} = 2 \left( \left[ \frac{1}{3}x^3+2x \right]_0^1 + \left[ -\frac{1}{3}x^3+4x \right]_1^2 \right) = 8 \]
(2) $x \ge 1$이면 $y=x^2-x$, $x < 1$이면 $y=-x^2+x$이다.
\[ S = \int_{-1}^0 (x^2-x) dx + \int_0^1 (-x^2+x) dx + \int_1^2 (x^2-x) dx = \frac{5}{6} + \frac{1}{6} + \frac{5}{6} = \frac{11}{6} \]
...
\textbf{모범답안}\\
교점은 $x=0, a, 2$이다.\\
(1) $\int_{0}^{2} \{x^3-(a+2)x^2+2ax\} dx = 0$ 이어야 하므로 $\left[ \frac{1}{4}x^4 - \frac{1}{3}(a+2)x^3 + ax^2 \right]_0^2 = 0 \Rightarrow a=1$.\\
(2) $S(a) = \int_0^a y dx - \int_a^2 y dx = -\frac{1}{6}a^4 + \frac{2}{3}a^3 - \frac{4}{3}a + \frac{4}{3}$이다. $S'(a) = -\frac{2}{3}(a-1)(a^2-2a-2)$. $0 < a < 2$에서 $a=1$일 때 $S(a)$는 최소가 된다.
...
\[ S = \int_{-1}^2 \{(x+1)-(x^2-1)\} dx = \left[ -\frac{1}{3}x^3 + \frac{1}{2}x^2 + 2x \right]_{-1}^2 = \frac{9}{2} \]
(2) 교점: $x(x-1)(x-2)=x(x-1) \Rightarrow x=0, 1, 3$.
\[ S = \int_0^1 (x^3-4x^2+3x) dx + \int_1^3 (-x^3+4x^2-3x) dx = \frac{5}{12} + \frac{8}{3} = \frac{37}{12} \]
...
\[ S = \int_{-2}^1 \{(y+2)-(y^2+2y)\} dy = \left[ -\frac{1}{3}y^3 - \frac{1}{2}y^2 + 2y \right]_{-2}^1 = \frac{9}{2} \]
(2) 교점: $(y-2)^4+(y-1)^2=1 \Rightarrow y=1, 2$. 평행이동을 이용하여 구하면
\[ S = \frac{\pi}{4} - \int_0^1 (y-1)^2 dy = \frac{\pi}{4} - \left[ \frac{1}{3}(y-1)^3 \right]_0^1 = \frac{\pi}{4} - \frac{1}{3} \]
...
\textbf{모범답안}\\
교점은 $x=0, 1, a$이다.\\
(1) $\int_0^a x(a-x) dx = 2 \int_0^a x^2(a-x) dx \Rightarrow \frac{a^3}{6} = 2 \frac{a^4}{12} = \frac{a^4}{6}$. $a \ne 0$이므로 $a=1$.\\
(2) $\int_0^a \{x(a-x) - x^2(a-x)\} dx = 0$ 이어야 하므로 $\left[ \frac{a}{2}x^2 - \frac{1+a}{3}x^3 + \frac{1}{4}x^4 \right]_0^a = 0 \Rightarrow a=2$.
...
\[ S = 2 \int_{-1}^0 (f(x)-x) dx + 2 \times (\triangle \text{넓이}) = 2 \left[ \frac{1}{4}x^4 + x^3 + \frac{3}{2}x^2 + x \right]_{-1}^0 + \frac{1}{2} = 1 \]
...
\[ S = \triangle \text{넓이} + \int_0^3 \{x^3-5x^2+x+9-(-2x)\} dx = \frac{27}{2} + \frac{63}{4} = \frac{117}{4} \]
...
(2) $x^3=3x^2-4$의 교점은 $x=-1, 2$(중근). $S = \int_{-1}^2 \{x^3-(3x^2-4)\} dx = \left[ \frac{1}{4}x^4 - x^3 + 4x \right]_{-1}^2 = \frac{27}{4}$.
...
\begin{studybox}
점 $P$의 좌표를 $(a, -a^2+2a)$로 놓고 접선을 구한 뒤, 교점 $\alpha, \beta$와 넓이 공식 $S = \frac{1}{6}(\beta-\alpha)^3$을 이용한다.
\end{studybox}

\textbf{모범답안}\\
접선: $y=-2(a-1)x+a^2$. $x^2 = -2(a-1)x+a^2$의 두 근 $\alpha, \beta$에 대하여 $\beta-\alpha = 2\sqrt{2a^2-2a+1}$이다. $S(a) = \frac{4}{3}(2a^2-2a+1)^{3/2}$이므로 $a=1/2$일 때 최소가 된다. 점 $P(1/2, 3/4)$.
