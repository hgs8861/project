...
\end{tcolorbox}
\textbf{경면의 식 유도.}  점 \((x_0,y_0,z_0)\)를 지나고 방향코사인이 \(\lambda,\mu,\nu\)인 직선
\[
...
\textbf{주경면의 식 유도.} 방향코사인 \(\lambda,\mu,\nu\)인 직선과 경면 ①이 직교할 조건은
\[
