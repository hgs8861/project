...
\centering
\begin{tikzpicture}
\begin{axis}[hide axis, view={30}{12}, width=5.5cm, height=5.5cm]
\addplot3[
    surf, shader=faceted, faceted color=teal!60, fill=teal!15, opacity=0.7,
    domain=0:1.3, domain y=0:360, samples=10, samples y=20, z buffer=sort,
]
({2*cosh(x)}, {1.3*sinh(x)*cos(y)}, {1.3*sinh(x)*sin(y)});
\addplot3[
