...
\textbf{모범답안} \\
$T_{n}=(\dfrac{1}{n})^{3}\dfrac{1}{n}+(\dfrac{2}{n})^{3}\dfrac{1}{n}+\cdot\cdot\cdot+(\dfrac{n}{n})^{3}\dfrac{1}{n} = \dfrac{1}{n^{4}}(1^{3}+2^{3}+\cdot\cdot\cdot+n^{3}) = \dfrac{1}{n^4}\{\dfrac{n(n+1)}{2}\}^2 = \dfrac{1}{4}(1+\dfrac{1}{n})^2$ \\
...
\textbf{모범답안} \\
(1) $\displaystyle \dfrac{\int_0^1 (1+x)^3 dx}{\int_0^1 x^3 dx} = \mathbf{15}$ \quad (2) $\displaystyle \int_0^1 x \cos(\dfrac{\pi}{2}x^2) dx = \mathbf{\dfrac{1}{\pi}}$ \quad (3) $\displaystyle \int_0^1 x^2 e^x dx = \mathbf{e-2}$ 
...
\begin{figure}[htbp] % [h!] 옵션은 여기에(here!) 그림을 위치시키라는 의미
  ...
  \includegraphics[width=0.7\textwidth]{graph12.png} % 너비는 텍스트 너비의 70%    
\end{figure}
...
$S=1+\dfrac{1}{2}+\dfrac{1}{3}+\cdots+\dfrac{1}{n}$ 이라 하면, $S$ 는 $y=\dfrac{1}{x}$ 의 그래프와 $x$ 축 사이의 영역을 나타낸다. 이 영역의 넓이 비교에 의해 $S > \int_1^{n+1} \dfrac{1}{x} dx = \ln(n+1)$ 이고, $S-1 < \int_1^n \dfrac{1}{x} dx = \ln n$ 이므로 성립한다. 
...
\textbf{모범답안} \\
(1) $0 \le x \le 1$ 에서 $\dfrac{1}{2} \le \dfrac{1}{1+x^2} \le 1$ 이므로 성립. (2) $1 \le (\sin x + \cos x)^2 \le 2$ 이므로 성립. 
