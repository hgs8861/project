...
\begin{wrapfigure}{r}{0.28\textwidth} % [h!] 옵션은 여기에(here!) 그림을 위치시키라는 의미
  \includegraphics[width=0.28\textwidth]{graph3.png} % 너비는 텍스트 너비의 70%    
\end{wrapfigure}
(1) $|x|<1$이면 $y=x^2+2$, $|x| \ge 1$이면 $y=-x^2+4$이다. $y=0$과의 교점은 $x = \pm 2$이다. 그래프의 대칭성을 이용하면
\[ S = 2 \left\{ \int_0^1 (x^2+2) dx + \int_1^2 (-x^2+4) dx \right\} \] 
\[=2 \left( \left[ \dfrac{1}{3}x^3+2x \right]_0^1 + \left[ -\dfrac{1}{3}x^3+4x \right]_1^2 \right) = 8 \]\\

\begin{wrapfigure}{r}{0.28\textwidth} % [h!] 옵션은 여기에(here!) 그림을 위치시키라는 의미
  \includegraphics[width=0.28\textwidth]{graph4.png} % 너비는 텍스트 너비의 70%    
\end{wrapfigure}
(2) $x \ge 1$이면 $y=x^2-x$, $x < 1$이면 $y=-x^2+x$이다.
\[ S = \int_{-1}^0 (x^2-x) dx + \int_0^1 (-x^2+x) dx + \int_1^2 (x^2-x) dx\] 
...
\begin{figure}[htbp] % [h!] 옵션은 여기에(here!) 그림을 위치시키라는 의미
  ...
  \includegraphics[width=0.3\textwidth]{graph5.png} % 너비는 텍스트 너비의 70%    
\end{figure}
...
\textbf{모범답안}
\begin{wrapfigure}{r}{0.25\textwidth} % [h!] 옵션은 여기에(here!) 그림을 위치시키라는 의미
  \includegraphics[width=0.25\textwidth]{graph6.png} % 너비는 텍스트 너비의 70%    
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.32\textwidth} % [h!] 옵션은 여기에(here!) 그림을 위치시키라는 의미
  \includegraphics[width=0.3\textwidth]{graph7.png} % 너비는 텍스트 너비의 70%    
\end{wrapfigure} 

(2) 교점: $x(x-1)(x-2)=x(x-1) \Rightarrow x=0, 1, 3$.
\[S = \int_0^1 (x^3-4x^2+3x) dx + \int_1^3 (-x^3+4x^2-3x) dx\] 
\[= \dfrac{5}{12} + \dfrac{8}{3} = \dfrac{37}{12} \]\\\\
...
\textbf{모범답안}\\
\begin{wrapfigure}{r}{0.3\textwidth} % [h!] 옵션은 여기에(here!) 그림을 위치시키라는 의미
  \includegraphics[width=0.28\textwidth]{graph8.png} % 너비는 텍스트 너비의 70%    
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.3\textwidth} % [h!] 옵션은 여기에(here!) 그림을 위치시키라는 의미
  \includegraphics[width=0.3\textwidth]{graph9.png} % 너비는 텍스트 너비의 70%    
\end{wrapfigure}
...
\begin{figure}[htbp]% [h!] 옵션은 여기에(here!) 그림을 위치시키라는 의미
  \centering
  \includegraphics[width=0.28\textwidth]{graph10.png} % 너비는 텍스트 너비의 70%    
\end{figure} 
