...
\begin{wrapfigure}[10]{r}{0.25\textwidth}
    \vspace{-20pt}
    \centering
    \includegraphics[width=0.25\textwidth]{graph27.png}
\end{wrapfigure} 
...
\begin{wrapfigure}[13]{r}{0.25\textwidth}
    \vspace{-20pt}
    \centering
    \includegraphics[width=0.25\textwidth]{graph30.png}
\end{wrapfigure}
...
$\dfrac{d}{dx} \int_{a}^{x} S(t) dt = S(x)$ ($a$는 상수)
\end{studybox}
...
\begin{wrapfigure}[4]{l}{0.2\textwidth}
    \vspace{-20pt}
    \centering
    \includegraphics[width=0.2\textwidth]{graph28.png}
\end{wrapfigure} 
...
\begin{studybox}
$x$축 둘레로 회전시킨 입체의 부피는 $\pi \int_{a}^{b} y^2 dx$
\end{studybox}
...
\begin{wrapfigure}[6]{l}{0.25\textwidth}
    \vspace{-20pt}
    \centering
    \includegraphics[width=0.25\textwidth]{graph31.png}
\end{wrapfigure}
...
\begin{studybox}
$y$축 둘레로 회전시킨 입체의 부피는 $\pi \int_{\alpha}^{\beta} x^2 dy$ \\
...
\begin{wrapfigure}[7]{l}{0.2\textwidth}
    \vspace{-20pt}
    \centering
    \includegraphics[width=0.2\textwidth]{graph32.png}
\end{wrapfigure}
...
\begin{wrapfigure}[4]{l}{0.25\textwidth}
    \vspace{-40pt}
    \centering
    \includegraphics[width=0.25\textwidth]{graph33.png}
\end{wrapfigure}
...
\begin{wrapfigure}[4]{l}{0.23\textwidth}
    \vspace{-20pt}
    \centering
    \includegraphics[width=0.23\textwidth]{graph34.png}
\end{wrapfigure}
...
\begin{wrapfigure}[2]{l}{0.2\textwidth}
    \vspace{-20pt}
    \centering
    \includegraphics[width=0.2\textwidth]{graph35.png}
\end{wrapfigure}
...
\begin{wrapfigure}[5]{l}{0.3\textwidth}
    \vspace{-20pt}
    \centering
    \includegraphics[width=0.3\textwidth]{graph36.png}
\end{wrapfigure}
점 찍은 두 부분에 의하여 생기는 입체의 부피가 같으므로 
$V = 2\pi \left( \int_{\pi/4}^{3\pi/4} \sin^2 x dx - \int_{\pi/4}^{\pi/2} \cos^2 x dx \right)$ \\
$= 2\pi \left( \int_{\pi/4}^{3\pi/4} \dfrac{1-\cos 2x}{2} dx - \int_{\pi/4}^{\pi/2} \dfrac{1+\cos 2x}{2} dx \right)$ 
...
\textbf{모범답안} \\
\begin{wrapfigure}[3]{l}{0.23\textwidth}
    \vspace{-20pt}
    \centering
    \includegraphics[width=0.23\textwidth]{graph37.png}
\end{wrapfigure}
...
\begin{wrapfigure}[5]{l}{0.23\textwidth}
    \vspace{-20pt}
    \centering
    \includegraphics[width=0.23\textwidth]{graph38.png}
\end{wrapfigure}
