...
\begin{longtable}{p{0.47\textwidth} | p{0.47\textwidth}}
    ...
    \end{enumerate}} 
    & 
    \exercise{반지름의 길이가 $r$ 인 원 위에 한 점 $P$ 와 이 점에서 원에 접하는 직선 $l$ 이 있다. 점 $P$ 를 지나는 현이 직선 $l$ 과 이루는 각의 크기가 $\dfrac{\pi k}{2n} (k=1, 2, \dots, 2n-1)$ 일 때, 현의 길이를 $r_k$ 라고 하자. $\displaystyle \lim_{n \to \infty} \dfrac{1}{2n-1} \sum_{k=1}^{2n-1} r_k^2$ 의 값을 구하여라.} \\
