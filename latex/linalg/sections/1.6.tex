...
Solve\\ (a) $x_1+2x_2+3x_3=4,\ 2x_1+5x_2+3x_3=5,\ x_1+8x_3=9$ \\ (b) $x_1+2x_2+3x_3=1,\ 2x_1+5x_2+3x_3=6,\ x_1+8x_3=-6$.
...
\end{tcolorbox}
\textbf{Proof (a)} It suffices to show $A$ is invertible; then multiplying $BA=I$ on the right by $A^{-1}$ gives $B=A^{-1}$. \\
By Theorem 1.5.3, it suffices to show $A\mathbf{x}=\mathbf{0}$ has only the trivial solution. If $A\mathbf{x}_0=\mathbf{0}$, multiplying on the left by $B$ gives $BA\mathbf{x}_0=B\mathbf{0}$, i.e., $\mathbf{x}_0=\mathbf{0}$. $\blacksquare$
